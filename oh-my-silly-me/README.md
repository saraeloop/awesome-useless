...
|--------|-------------|----------------------|
| tamagotchi | virtual pet | dies immediately |
| enya | error handling | replaces errors with Enya |
| dialup | authenticity | makes everything slow |
| blink | accessibility | claims to blink |
